...
function getDefaultKisiKisi(subject = "Mata Pelajaran", topic = "Topik Pembelajaran"): KisiKisiItem[] {
  return [
    { no: 1, tujuanPembelajaran: `Murid dapat mengidentifikasi konsep dasar ${topic} pada ${subject}.`, indikator: `Menjelaskan pengertian dan konsep utama ${topic}.`, materi: topic, levelKognitif: "L1 - C2 (Memahami)", nomorSoal: "1", bentukSoal: "Pilihan Ganda", kunciJawaban: "A", skorPerSoal: 4, tingkat: "L1 - C2 (Memahami)" },
    { no: 2, tujuanPembelajaran: `Murid dapat mengidentifikasi prinsip penting ${topic}.`, indikator: `Menentukan ciri-ciri dan unsur utama ${topic}.`, materi: topic, levelKognitif: "L1 - C2 (Memahami)", nomorSoal: "2", bentukSoal: "Pilihan Ganda", kunciJawaban: "B", skorPerSoal: 4, tingkat: "L1 - C2 (Memahami)" },
    { no: 3, tujuanPembelajaran: `Murid dapat mengaplikasikan konsep ${topic} dalam kehidupan sehari-hari.`, indikator: `Menentukan contoh penerapan ${topic} yang tepat.`, materi: topic, levelKognitif: "L2 - C3 (Menerapkan)", nomorSoal: "3", bentukSoal: "Pilihan Ganda", kunciJawaban: "C", skorPerSoal: 4, tingkat: "L2 - C3 (Menerapkan)" },
    { no: 4, tujuanPembelajaran: `Murid dapat menganalisis permasalahan kontekstual terkait ${topic}.`, indikator: `Menganalisis sebab-akibat atau solusi pada masalah ${topic}.`, materi: topic, levelKognitif: "L3 - C4 (Menganalisis)", nomorSoal: "4", bentukSoal: "Pilihan Ganda", kunciJawaban: "A", skorPerSoal: 4, tingkat: "L3 - C4 (Menganalisis)" },
    { no: 5, tujuanPembelajaran: `Murid dapat mengevaluasi penerapan materi ${topic}.`, indikator: `Menilai kebenaran langkah atau pernyataan terkait ${topic}.`, materi: topic, levelKognitif: "L3 - C5 (Mengevaluasi)", nomorSoal: "5", bentukSoal: "Pilihan Ganda", kunciJawaban: "D", skorPerSoal: 4, tingkat: "L3 - C5 (Mengevaluasi)" },
    { no: 6, tujuanPembelajaran: `Murid dapat mengurutkan atau mengklasifikasikan bagian-bagian ${topic}.`, indikator: `Mengurutkan proses atau tahapan pada ${topic}.`, materi: topic, levelKognitif: "L2 - C3 (Menerapkan)", nomorSoal: "6", bentukSoal: "Pilihan Ganda", kunciJawaban: "B", skorPerSoal: 4, tingkat: "L2 - C3 (Menerapkan)" },
    { no: 7, tujuanPembelajaran: `Murid dapat menghubungkan materi ${topic} dengan kehidupan nyata.`, indikator: `Menjelaskan kaitan ${topic} dengan manfaat sehari-hari.`, materi: topic, levelKognitif: "L2 - C3 (Menerapkan)", nomorSoal: "7", bentukSoal: "Pilihan Ganda", kunciJawaban: "C", skorPerSoal: 4, tingkat: "L2 - C3 (Menerapkan)" },
    { no: 8, tujuanPembelajaran: `Murid dapat membandingkan opsi/solusi dalam materi ${topic}.`, indikator: `Memilih alternatif terbaik dalam persoalan ${topic}.`, materi: topic, levelKognitif: "L3 - C4 (Menganalisis)", nomorSoal: "8", bentukSoal: "Pilihan Ganda", kunciJawaban: "A", skorPerSoal: 4, tingkat: "L3 - C4 (Menganalisis)" },
    { no: 9, tujuanPembelajaran: `Murid dapat menyimpulkan poin utama materi ${topic}.`, indikator: `Menarik kesimpulan dari deskripsi atau data ${topic}.`, materi: topic, levelKognitif: "L3 - C4 (Menganalisis)", nomorSoal: "9", bentukSoal: "Pilihan Ganda", kunciJawaban: "B", skorPerSoal: 4, tingkat: "L3 - C4 (Menganalisis)" },
    { no: 10, tujuanPembelajaran: `Murid dapat menerapkan nilai-nilai pembelajaran ${topic}.`, indikator: `Menentukan sikap positif saat mempelajari ${topic}.`, materi: topic, levelKognitif: "L2 - C3 (Menerapkan)", nomorSoal: "10", bentukSoal: "Pilihan Ganda", kunciJawaban: "A", skorPerSoal: 4, tingkat: "L2 - C3 (Menerapkan)" },
    { no: 11, tujuanPembelajaran: `Murid dapat menjelaskan konsep ${topic} secara komprehensif.`, indikator: `Jelaskan pengertian dan 2 manfaat utama dari ${topic}!`, materi: topic, levelKognitif: "L1 - C2 (Memahami)", nomorSoal: "1 (Uraian)", bentukSoal: "Uraian", kunciJawaban: `${topic} adalah bagian dari ${subject} yang dipelajari untuk meningkatkan pemahaman dan keterampilan peserta didik.`, skorPerSoal: 12, tingkat: "L1 - C2 (Memahami)" },
    { no: 12, tujuanPembelajaran: `Murid dapat menyebutkan tahapan/langkah dalam ${topic}.`, indikator: `Tuliskan langkah-langkah utama dalam mempelajari atau menerapkan ${topic}!`, materi: topic, levelKognitif: "L2 - C3 (Menerapkan)", nomorSoal: "2 (Uraian)", bentukSoal: "Uraian", kunciJawaban: `1. Pemahaman konsep dasar ${topic}\n2. Eksplorasi & analisis\n3. Penerapan dalam tugas`, skorPerSoal: 12, tingkat: "L2 - C3 (Menerapkan)" },
    { no: 13, tujuanPembelajaran: `Murid dapat menganalisis persoalan nyata terkait ${topic}.`, indikator: `Mengapa pemahaman tentang ${topic} sangat penting bagi kehidupan sehari-hari? Jelaskan!`, materi: topic, levelKognitif: "L3 - C4 (Menganalisis)", nomorSoal: "3 (Uraian)", bentukSoal: "Uraian", kunciJawaban: `Pemahaman tentang ${topic} membantu peserta didik berpikir logis, kritis, dan solutif.`, skorPerSoal: 12, tingkat: "L3 - C4 (Menganalisis)" },
    { no: 14, tujuanPembelajaran: `Murid dapat memberikan contoh konkret ${topic}.`, indikator: `Berikan 2 contoh konkret penerapan ${topic} di lingkungan sekitar!`, materi: topic, levelKognitif: "L2 - C3 (Menerapkan)", nomorSoal: "4 (Uraian)", bentukSoal: "Uraian", kunciJawaban: `Contoh 1: Penerapan di kelas/sekolah\nContoh 2: Penerapan di lingkungan tempat tinggal`, skorPerSoal: 12, tingkat: "L2 - C3 (Menerapkan)" },
    { no: 15, tujuanPembelajaran: `Murid dapat merumuskan solusi atas permasalahan ${topic}.`, indikator: `Bagaimana solusi terbaik jika menghadapi kendala terkait ${topic}?`, materi: topic, levelKognitif: "L3 - C6 (Mencipta)", nomorSoal: "5 (Uraian)", bentukSoal: "Uraian", kunciJawaban: `Melakukan analisis penyebab masalah, berdiskusi kelompok, dan merumuskan langkah inovatif penyelesaian masalah.`, skorPerSoal: 12, tingkat: "L3 - C6 (Mencipta)" },
  ];
}
